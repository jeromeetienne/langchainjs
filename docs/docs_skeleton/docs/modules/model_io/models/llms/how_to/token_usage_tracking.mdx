...
Additionally it provides a way to cumulate cost from various origins is provided as a convenience.
...
```OpenAiTokenCost``` provices a way to cumulate cost from various origins is provided as a convenience.
