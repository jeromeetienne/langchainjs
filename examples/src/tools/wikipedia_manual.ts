...
// import { Wikipedia } from "langchain/tools/wikipedia";


// import { ChatOpenAI } from "langchain/chat_models/openai";
// import { OpenAIEmbeddings } from "langchain/embeddings/openai";

import { Wikipedia, WikipediaApiWrapper, WikipediaTool } from '../../../langchain/src/tools/wikipedia_OLD.js';
...
export async function run() {
	...
	// debugger
	const wikipediaApiWrapper = new WikipediaApiWrapper();
	// FIXME this is not working yet
	// wikipediaApiWrapper.contentType = this.contentType
	// wikipediaApiWrapper.topKResults = this.topKResults
	const loadedDocuments = await wikipediaApiWrapper.run('batman');
